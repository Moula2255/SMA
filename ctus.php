...
$show = "select * from tblpage where PageType='contact us'";
...
if(isset($_POST['submit'])){
   ...
   $pgem = $_POST['em'];
   $pgmd = $_POST['mb'];
   $up="update tblpage set PageTitle='$pgtl',PageDescription='$pgdes',Email='$pgem',MobileNumber='$pgmd' where PageType='contact us'";
...
<body>
    ...
    <div class="d-flex justify-content-between px-2 pt-5 pb-2">
        ...
        <h4 class="text-center">Update About Us</h4>
           ...
           <textarea type="text" class="form-control" name="pd"><?php echo $pd;  ?></textarea>
           <label for="" class="form-label">Email:</label>
           <input type="text" class="form-control" name="em" value="<?php echo $row['Email'] ?>">
           <label for="" class="form-label">Mobile Number:</label>
           <input type="text" class="form-control mb-2" name="mb" value="<?php echo  $row['MobileNumber'] ?>">
